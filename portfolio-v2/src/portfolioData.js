...
export const projects = [
  {
    ...
    description: "A collaborative vr application developed as a capstone project at Bellevue College.",
    imageUrls: [
        vr1Image,
        vr2Image,
        vr3Image,
  ...
  },
  {
    ...
    imageUrls: [
        "https://placehold.co/600x400/8d82c4/ffffff?text=Future+Image+1",
        "https://placehold.co/600x400/8d82c4/ffffff?text=Future+Image+2",
        "https://placehold.co/600x400/8d82c4/ffffff?text=Future+Image+3",
    ],
    liveUrl: "#",
...
export const featuredRepos = [
    ...
    description: "Capstone project built with Unity.",
    html_url: "https://github.com/rPhoenix10/Capstone"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    html_url: "https://github.com/rPhoenix10"
  },
];
